...
class Authentication extends Component {
    ...
    render(){
        ...
        return (
            <div>
                {this.props.loggedIn ? userLoggedIn : userNotLoggedInMaterial}
            </div>
        )
    }
}
...
export default connect(mapStateToProps)(withStyles(loginPageStyle)(Authentication))